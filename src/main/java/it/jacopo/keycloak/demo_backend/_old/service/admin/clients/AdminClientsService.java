package it.jacopo.keycloak.demo_backend._old.service.admin.clients;

import it.jacopo.keycloak.demo_backend._old.admin.KeycloakTokenClient;
import it.jacopo.keycloak.demo_backend._old.admin.clients.KeycloakAdminClientsClient;
import it.jacopo.keycloak.demo_backend._old.dto.KeycloakRoleDTO;
import it.jacopo.keycloak.demo_backend._old.dto.KeycloakUserRoleDTO;
import it.jacopo.keycloak.demo_backend._old.dto.external.KeycloakRoleExternalDTO;
import it.jacopo.keycloak.demo_backend._old.dto.external.RoleRepresentationExternalDTO;
import it.jacopo.keycloak.demo_backend._old.mapper.RoleUserDTOMapper;
